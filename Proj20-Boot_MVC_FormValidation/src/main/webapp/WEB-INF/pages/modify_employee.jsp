...
<link
	...
	rel="stylesheet">
<script
	src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script><title>Modify Employee Page</title>
</head>
<body>
	<div class="container">
		<h1 class="bg-secondary text-white text-center mt-3">Employee Modification Form</h1>
		<form:form modelAttribute="emp" cssClass="mb-3 mt-3">			
			<label for = "empno" class="form-label">Emplyee No. : </label>
			<form:input id="empno" cssClass="form-control" path="empno" readonly="true"/>
		...
		<div class = "mt-3">
			<input type = "submit" class = "btn btn-primary" style = "width : 40%" value = "Update"/>
